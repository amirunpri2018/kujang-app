...
use System\Exception\InvalidMethodException;
use System\Exception\MethodNotAllowedException;
use System\Exception\NotFoundException;
use System\Exception\SystemException;
use System\Http\Body;
 ...
 * configure, and run a System Framework application.
 * The \System\App class also accepts System Framework middleware.
 *
...
class App
{
     ...
     *
     * @throws \Interop\Container\Exception\ContainerException
     * @throws \System\Exception\MethodNotAllowedException
     * @throws \System\Exception\NotFoundException
     * @throws \Throwable
     */
    ...
    public function respond ( ResponseInterface $response )
    {
        ...
        if ( !headers_sent() ) {
            ...
            // See https://github.com/Systemphp/System/issues/1730
    ...
    public function __invoke ( ServerRequestInterface $request, ResponseInterface $response )
    {
        ...
        /** @var \System\Interfaces\RouterInterface $router */
        $router = $this->container->get( 'router' );
